...
public class sendMail {
	    ...
	    public static String myEmailAccount = "yunxian_tiandan@163.com";
	    public static String myEmailPassword = "786943986";
	    ...
	    // 收件人邮箱（替换为自己知道的有效邮箱）
	    public static String receiveMailAccount = "yunxian_tiandan@163.com";
	    ...
	    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
	        ...
	        DataHandler dh = new DataHandler(new FileDataSource("d://293320//Desktop//330711610658215698.jpg")); // 读取本地文件
	        ...
	        DataHandler dh2 = new DataHandler(new FileDataSource("d://293320//Desktop//正式环境账号.docx"));  // 读取本地文件
